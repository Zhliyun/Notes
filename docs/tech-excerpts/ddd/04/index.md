...
prev:
  ...
  link: '/tech-excerpts/ddd/03/10'
next:
  text: '基于 DDD 的微服务设计实例代码详解'
  link: '/tech-excerpts/ddd/04/01'
---

# 所谓高手，就是跨过坑和大海！

我站在架构师的角度，尽力将我在实践过程中的经验、思考和体会，以及原创案例等全面详细地呈现给你。希望能够对你的 DDD 实践和架构设计有所帮助，也希望你能快速成长为具有企业级战略视角的架构师和 DDD 设计大师。
